          ...
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-section">
                ...
                <h4 class="text-section">Quản lý hệ thống</h4>
              </li>
              <li class="nav-item">
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="${pageContext.request.contextPath}/admin/menu/list">
                        <span class="sub-item">Danh sách menu</span>
                      </a>
                    </li>
                    <li>
                      <a href="${pageContext.request.contextPath}/admin/menu/add">
                        <span class="sub-item">Thêm menu</span>
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <li class="nav-section">
                ...
                <h4 class="text-section">Quản lý sản phẩm</h4>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#productCategoryManagement">
                  <i class="fas fa-tags"></i>
                  <p>Quản lý danh mục sản phẩm</p>
                  <span class="caret"></span>
                </a>
                <div class="collapse" id="productCategoryManagement">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="${pageContext.request.contextPath}/admin/product-category/list">
                        <span class="sub-item">Danh sách danh mục</span>
                      </a>
                    </li>
                    <li>
                      <a href="${pageContext.request.contextPath}/admin/product-category/add">
